...
namespace WindowsFormsApp1
{
    class ParkingMain
    {
        ...
        public static string findVehicle(Vehicle v)
        {
            ...
            //returning value in such a format so that can be used later as well just by calling String.Split function
            // and get the number of the level and the parking spot place number of the 
            //vehicle parked
            return "/-1";
        }
    }
